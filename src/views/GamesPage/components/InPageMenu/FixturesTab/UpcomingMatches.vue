<template>
  <div class="matches-section">
    <div tabindex="0" class="collapse collapse-arrow border-base-300 bg-base-100 border border-base-300">
      ...
      <div class="collapse-title font-semibold">Upcoming Matches</div>

      <div class="collapse-content">
        <div v-if="upcomingMatches.length > 0">
          <div v-for="match in upcomingMatches" :key="match.id" class="match-card live">
        ...
        <div v-else class="no-matches">No upcoming matches.</div>
      </div>
    </div>
  </div>
</template>
